...
public final class Constants {
    ...
    public static final String GET_SALE = "http://demo.wasetco.com/api/sale";
    public static final String GET_RENT = "http://demo.wasetco.com/api/rent";
    public static final String GET_AGENTS = "http://demo.wasetco.com/api/agents";
